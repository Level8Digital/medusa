  ...
  <div class="section">
    <div class="container">
      ...
      <div class="text-center mt-8">
        <h2><em>Trading Insights #3:</em> Mastering Your Mind</h2>
        <p>April 25, 2022 in <a href="{{ url('insights') }}">Insights</a></p>
      </div>

      <div class="text-center my-8">
        <img class="rounded-md blog-img" src="{{ url('assets/img/mind-opt.jpg') }}" alt="...">
      </div>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <h4 class="mt-20">Trading Pitfalls</h4>
          <p class="lead">
          ...
          <ol>
            ...
            <li>
              Blaming the market for your failures rather than taking responsibility
            </li>
            <li>
              Trying to get rich quick by trading in an aggressive and reckless fashion
            </li>
            <li>
              Not viewing your trading exploits over a set of trades and over-emphasizing individual trades
            </li>
          </ol>

          <h4 class="mt-20">Error #1: Not believing you need a defined strategy</h4>
          <p class="lead">
            This is one of the most common and difficult to break trading habits. The market is a limitless environment where you can do whatever you want, whenever you want. Many traders enjoy this type of freedom and struggle to develop or follow trading rules. Some traders give lip service to the idea they need a defined game plan, but when it comes down to it they don’t embody or act out the belief that rules are necessary.
          </p>
          ...
          <blockquote class="blockquote">
            ...
            <footer class="mt-5">Buddha</footer>
          </blockquote>
          ...
          <h4 class="mt-20">Error #2: Blaming the market for your failures</h4>
          <p class="lead">
          ...
          <h4 class="mt-20">Error #3: Trying to get rich quick by trading in an aggressive and reckless fashion</h4>
          <p class="lead">
          ...
          <blockquote class="blockquote">
            <div class="quote-sign"></div>
            <p>Patience is key. Remember: A jug fills drop by drop.</p>
            <footer class="mt-5">Buddha</footer>
          </blockquote>
          ...
          <h4 class="mt-20">Error #4: Not viewing your trading exploits over a set of trades</h4>
          <p class="lead">
          ...
          <blockquote class="blockquote">
            <div class="quote-sign"></div>
            <p>Nothing ever exists entirely alone; everything is in relation to everything else.</p>
            <footer class="mt-5">Buddha</footer>
          </blockquote>
