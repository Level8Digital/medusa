    ...
    <section class="section bg-repeat" data-overlay-light="5">
      <div class="container">
        <header class="section-header">
          ...
          <p class="lead-2">
            While you wait, head over to our <a class="teal-link" href="https://www.youtube.com/channel/UC_srdLV6WeXG2FYo8PguxhA">YouTube Channel</a> to learn how to use and access the Olympus Cloud,
